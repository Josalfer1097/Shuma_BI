...
import type { Hallazgo, Tono } from '@/lib/hallazgos'
 ...
 * una zona, los hallazgos hablan de esa zona.
 *
 * Va con createPortal por la misma razon de siempre: la barra de filtros vive
 * en un contenedor con overflow y recortaria cualquier hijo posicionado.
 */
