...
export default async function Page({ 
  ...
  const colsRanking = 'empresa, dimension, dimension_id, canal, dimension_codigo, dimension_nombre, reng_cotizados, reng_facturados, imp_cotizado, imp_facturado, imp_cot_convertido, imp_en_proceso, imp_sin_seguimiento, imp_suspendido, imp_cancelado, cotizaciones, cotiz_sin_seguimiento, cotiz_suspendidas, cotiz_canceladas, imp_reng_max, cant_reng_max, art_reng_max, reng_max_convertido, ultima_actividad, ultima_factura'
  const colsDetalle = 'empresa, fecha_cotizacion, canal, dimension, dimension_id, dimension_codigo, dimension_nombre, reng_cotizados, reng_facturados, imp_cotizado, imp_facturado, imp_cot_convertido, imp_en_proceso, imp_sin_seguimiento, imp_suspendido, imp_cancelado, imp_reng_max, cant_reng_max, art_reng_max, reng_max_convertido, cotizaciones, cotiz_sin_seguimiento, cotiz_suspendidas, cotiz_canceladas, actualizado_en'
